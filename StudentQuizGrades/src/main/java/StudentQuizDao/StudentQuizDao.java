...
public interface StudentQuizDao {
 ...
 return null.
     ...
     * 
     */
    Student addStudent(String studentId, Student student)throws StudentQuizDaoException;
    /**
     ...
     * @throws StudentQuizDao.StudentQuizDaoException
     */
    List<Student> getAllStudents() throws StudentQuizDaoException;
    /**
     ...
     * @throws StudentQuizDao.StudentQuizDaoException
     */
    Student getStudent(String studentId)throws StudentQuizDaoException;
     ...
     * @throws StudentQuizDao.StudentQuizDaoException
     */
    Student removeStudent(String studentId)throws StudentQuizDaoException;
    
    Student getScore1( int Score1)throws StudentQuizDaoException;
    
    Student getScore2(int Score2 )throws StudentQuizDaoException;
